    ...
    components: {
      ...
      schemas: {
        ...
        RSNumber: {
          ...
          properties: {
            _id: { type: 'string' },
            rsNumber: { type: 'string', example: 'RS-12345' },
            mouza: { type: 'string', example: 'Dhanmondi' },
            jlNumber: { type: 'string', example: 'JL-001' },
            khatianNumber: { type: 'string', example: 'KH-456' },
        ...
        Plot: {
          ...
          properties: {
            _id: { type: 'string' },
            rsNumberId: { type: 'string' },
            plotNumber: { type: 'string', example: 'P-001' },
            area: { type: 'number', example: 2500 },
            pricePerSqFt: { type: 'number', example: 5000 },
            status: {
              type: 'string',
            ...
            roadWidth: { type: 'number', example: 30 },
            notes: { type: 'string' },
            isActive: { type: 'boolean', example: true },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
