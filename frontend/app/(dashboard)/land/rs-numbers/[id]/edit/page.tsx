...
export default function EditRSNumberPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/land/rs-numbers/${params.id}`);
    } catch (error: any) {
    ...
    <div className="max-w-2xl">
      <div className="mb-6">
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-2">
          ...
          <span>/</span>
          <Link href={`/dashboard/land/rs-numbers/${params.id}`} className="hover:text-indigo-600">
            {rsNumber.rsNumber}
          </Link>
          <span>/</span>
          <span>Edit</span>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div className="flex gap-3 mt-6">
          ...
          <Link
            href={`/dashboard/land/rs-numbers/${params.id}`}
