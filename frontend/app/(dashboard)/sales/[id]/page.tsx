  ...
  if (!sale) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/dashboard/sales" className="text-indigo-600 hover:text-indigo-700 mt-4 inline-block">
          Back to Sales
        </Link>
      </div>
    );
    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-2">
          <Link href="/dashboard/sales" className="hover:text-indigo-600">
            Sales
          </Link>
          <span>/</span>
            ...
            <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                  <Link href={`/dashboard/clients/${client._id}`} className="text-indigo-600 hover:underline">
                    {client.name}
                  </Link>
                </dd>
              </div>
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                  <Link href={`/dashboard/land/plots/${plot._id}`} className="text-indigo-600 hover:underline">
                    {plot.plotNumber}
                  </Link>
                </dd>
              </div>
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                  <Link href={`/dashboard/land/rs-numbers/${rsNumber._id}`} className="text-indigo-600 hover:underline">
                    {rsNumber.rsNumber}
                  </Link>
                </dd>
              </div>
